...
public class SoundFile {
    ...
    public static SoundFile create(Context context, Uri uri) throws IOException, InvalidInputException {
        SoundFile soundFile = new SoundFile();
        soundFile.ReadFile(context, uri);
        return soundFile;
    }
    ...
    private void ReadFile(Context context, Uri uri) throws IOException, InvalidInputException {
        MediaExtractor extractor = new MediaExtractor();
        extractor.setDataSource(context, uri, null);
        ReadFile(extractor);
    }

    private void ReadFile(MediaExtractor extractor) throws InvalidInputException, IOException {
